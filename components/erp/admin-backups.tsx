...
export function AdminBackups({db,company}:{db:SupabaseClient;company:string}){
 ...
 return <div className="adm-backups">
  ...
  <div className="adm-backup-notice"><ShieldCheck size={21}/><p>As solicitações são autorizadas aqui e executadas pelo operador privado configurado no servidor. A restauração suspende as operações desta empresa até a conclusão. Fotos e arquivos 3MF guardados no banco exclusivo fazem parte da cópia. Arquivos antigos do Storage precisam ser migrados antes do corte.</p></div>
